...
namespace Infra.Migrations
{
    ...
    [Migration("20231025194147_AdicionandoValorPadraoParaQuantiaDesignada")]
    partial class AdicionandoValorPadraoParaQuantiaDesignada
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dominio.Salarios.Salario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dominio.Salarios.Salario", b =>
                {
                    b.HasOne("Dominio.Usuarios.Usuario", null)
                        .WithOne("Salario")
                        .HasForeignKey("Dominio.Salarios.Salario", "UsuarioId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.OwnsOne("Dominio.ObjetosDeValor.Quantia", "Quantia", b1 =>
                        {
                            b1.Property<int>("SalarioId")
                                .HasColumnType("int");
                    ...
                    b.OwnsOne("Dominio.ObjetosDeValor.Quantia", "Reserva", b1 =>
                        {
                            b1.Property<int>("SalarioId")
                                .HasColumnType("int");
